            ...
            if not comparison_data.empty:
                ...
                with col2:
                    try:
                        ...
                        forecast_2030 = predictions.loc['2030', scope] if '2030' in predictions.index else "2030 data not available"
                        forecast_2050 = predictions.loc['2050', scope] if '2050' in predictions.index else "2050 data not available"
